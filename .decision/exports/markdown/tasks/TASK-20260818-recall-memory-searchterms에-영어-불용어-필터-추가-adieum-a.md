---
id: TASK-20260818-recall-memory-searchterms에-영어-불용어-필터-추가-adieum-a
type: task
status: CLOSED
title: recall/memory searchTerms에 영어 불용어 필터 추가 (adieum-api 벤치마크에서 발견된 FTS5 노이즈 버그 수정)
record_depth: FULL
created_at: '2026-08-18T02:42:03.184Z'
updated_at: '2026-08-18T02:44:26.863Z'
---
# TASK-20260818-recall-memory-searchterms에-영어-불용어-필터-추가-adieum-a: recall/memory searchTerms에 영어 불용어 필터 추가 (adieum-api 벤치마크에서 발견된 FTS5 노이즈 버그 수정)

recall/memory searchTerms에 영어 불용어 필터 추가 (adieum-api 벤치마크에서 발견된 FTS5 노이즈 버그 수정)
...
```json sduck-source
{
  "task": {
    "id": "TASK-20260818-recall-memory-searchterms에-영어-불용어-필터-추가-adieum-a",
    "title": "recall/memory searchTerms에 영어 불용어 필터 추가 (adieum-api 벤치마크에서 발견된 FTS5 노이즈 버그 수정)",
    "description": "recall/memory searchTerms에 영어 불용어 필터 추가 (adieum-api 벤치마크에서 발견된 FTS5 노이즈 버그 수정)",
    "status": "CLOSED",
    "expectedScope": [
      "src/core/v2/search.ts"
    ],
    "avoidScope": [
      "패러프레이즈로 인한 어휘 불일치 문제 자체는 이번 스코프 밖 (키워드 검색의 근본적 한계, 임베딩 검색이 필요한 더 큰 결정)"
    ],
    "guided": true,
    "recordDepth": "FULL",
    "createdAt": "2026-08-18T02:42:03.184Z",
    "updatedAt": "2026-08-18T02:44:26.863Z",
    "implementationPlan": [
      "search.ts: ENGLISH_STOPWORDS Set 추가, searchTerms의 필터 체인에 stopword 제외 단계 추가"
    ],
    "verificationPlan": [
      "npm run build && npm test && npm run lint",
      "동일 쿼리로 sduck recall 재실행해 'and' 매칭 노이즈가 사라졌는지 확인",
      "sduck-recall-bench를 adieum-api에 재실행해 정량적 변화 확인"
    ]
  },
  "questions": [],
  "evidence": [
    {
      ...
      "sourceRef": "sduck-recall-bench --verbose against adieum-api",
      "summary": "DEC-0116 -> DEC-0024 쿼리 재현: 'and' 포함 시 top20 decisions가 전부 로그인/정산 등 무관한 내용으로 채워짐을 확인",
      "confidence": 0.7,
  ...
  "contextItems": [
    {
      ...
      "id": "CTX-1283",
      "createdAt": "2026-08-18T02:42:03.364Z"
    },
    {
      "taskId": "TASK-20260818-recall-memory-searchterms에-영어-불용어-필터-추가-adieum-a",
      "sourceType": "MEMORY",
    ...
    },
    {
      ...
      "id": "CTX-1285",
      "createdAt": "2026-08-18T02:42:03.365Z"
    },
    {
      "taskId": "TASK-20260818-recall-memory-searchterms에-영어-불용어-필터-추가-adieum-a",
      "sourceType": "MEMORY",
    ...
    },
    {
      ...
      "id": "CTX-1290",
      "createdAt": "2026-08-18T02:42:03.366Z"
    },
    {
      "taskId": "TASK-20260818-recall-memory-searchterms에-영어-불용어-필터-추가-adieum-a",
      "sourceType": "MEMORY",
    ...
    },
    {
      ...
      "id": "CTX-1295",
      "createdAt": "2026-08-18T02:42:03.367Z"
    },
    {
      "taskId": "TASK-20260818-recall-memory-searchterms에-영어-불용어-필터-추가-adieum-a",
      "sourceType": "MEMORY",
      "sourceRef": "DEC-MEMORY-CITED-SOURCE-SUPPRESSION",
      "summary": "Decision applies to relevant file src/core/v2/recall.ts: Suppress only raw sources actually cited by a matching capsule",
      "metadata": {
        "type": "decision",
        "kind": "EXPLICIT",
        "files": [
    ...
    },
    {
      ...
      "summary": "Decision applies to relevant file src/core/v2/memory-source.ts: Keep canonical history usable when a capsule reference breaks",
      "metadata": {
        "type": "decision",
        "kind": "EXPLICIT",
        "files": [
    ...
    },
    {
      ...
      "summary": "Decision applies to relevant file src/core/v2/memory-source.ts: Make memory digests, search patterns, and localized reasons portable",
      "metadata": {
        "type": "decision",
        "kind": "INFERRED",
        "files": [
    ...
    },
    {
      ...
      "id": "CTX-1300",
      "createdAt": "2026-08-18T02:42:03.368Z"
    },
    {
      "taskId": "TASK-20260818-recall-memory-searchterms에-영어-불용어-필터-추가-adieum-a",
      "sourceType": "MEMORY",
    ...
    },
    {
      ...
      "id": "CTX-1306",
      "createdAt": "2026-08-18T02:42:03.369Z"
    },
    {
      "taskId": "TASK-20260818-recall-memory-searchterms에-영어-불용어-필터-추가-adieum-a",
      "sourceType": "MEMORY",
    ...
    },
    {
      ...
      "id": "CTX-1309",
      "createdAt": "2026-08-18T02:42:03.370Z"
    },
    {
      "taskId": "TASK-20260818-recall-memory-searchterms에-영어-불용어-필터-추가-adieum-a",
      "sourceType": "MEMORY",
    ...
    },
    {
      ...
      "id": "CTX-1314",
      "createdAt": "2026-08-18T02:42:03.371Z"
    },
    {
      "taskId": "TASK-20260818-recall-memory-searchterms에-영어-불용어-필터-추가-adieum-a",
      "sourceType": "MEMORY",
    ...
    },
    {
      ...
      "id": "CTX-1317",
      "createdAt": "2026-08-18T02:42:03.372Z"
    },
    {
      "taskId": "TASK-20260818-recall-memory-searchterms에-영어-불용어-필터-추가-adieum-a",
      "sourceType": "MEMORY",
    ...
    },
    {
      ...
      "summary": "File evidence: \"path\": \"src/core/v2/memory.ts\",",
      "metadata": {
        "reason": "weak substring fallback",
        "score": 0.3,
        "attached": false,
        "excerpt": "\"path\": \"src/core/v2/memory.ts\",",
        "line": 213
      },
      "id": "CTX-1318",
      "createdAt": "2026-08-18T02:42:03.372Z"
    },
    {
      ...
      "summary": "File evidence: import { citedMemorySourceIds } from './memory-source.js';",
      "metadata": {
        "reason": "weak substring fallback",
        "score": 0.3,
        "attached": false,
        "excerpt": "import { citedMemorySourceIds } from './memory-source.js';",
        "line": 5
      },
      "id": "CTX-1319",
      "createdAt": "2026-08-18T02:42:03.372Z"
    },
    {
      "taskId": "TASK-20260818-recall-memory-searchterms에-영어-불용어-필터-추가-adieum-a",
      "sourceType": "DISCOVERY",
      "sourceRef": "tests/e2e/v2-memory-cli.test.ts",
      "summary": "File evidence: describeIfSqlite('v2 memory CLI', () => {",
      "metadata": {
        "reason": "weak substring fallback",
        "score": 0.3,
        "attached": false,
        "excerpt": "describeIfSqlite('v2 memory CLI', () => {",
        "line": 15
      },
      "id": "CTX-1320",
      "createdAt": "2026-08-18T02:42:03.372Z"
    },
    {
      "taskId": "TASK-20260818-recall-memory-searchterms에-영어-불용어-필터-추가-adieum-a",
      "sourceType": "DISCOVERY",
      "sourceRef": "tests/unit/v2-memory.test.ts",
      "summary": "File evidence: import { memorySourceDigest, type MemorySourceEntry } from '../../src/core/v2/memory-source.js';",
      "metadata": {
        "reason": "weak substring fallback",
        "score": 0.3,
        "attached": false,
        "excerpt": "import { memorySourceDigest, type MemorySourceEntry } from '../../src/core/v2/memory-source.js';",
        "line": 12
      },
      "id": "CTX-1321",
      "createdAt": "2026-08-18T02:42:03.372Z"
    },
    {
      "taskId": "TASK-20260818-recall-memory-searchterms에-영어-불용어-필터-추가-adieum-a",
      "sourceType": "DISCOVERY",
      "sourceRef": "tests/unit/v2-recall.test.ts",
      "summary": "File evidence: describeIfSqlite('v2 recall hybrid search', () => {",
      "metadata": {
        "reason": "weak substring fallback",
        "score": 0.3,
        "attached": false,
        "excerpt": "describeIfSqlite('v2 recall hybrid search', () => {",
        "line": 12
      },
      "id": "CTX-1322",
      "createdAt": "2026-08-18T02:42:03.372Z"
  ...
  "briefSnapshots": [
    {
      ...
      "snapshot": {
        "task": {
          ...
          "recordDepth": "FULL",
          "createdAt": "2026-08-18T02:42:03.184Z",
          "updatedAt": "2026-08-18T02:43:52.613Z",
          "implementationPlan": [
            "search.ts: ENGLISH_STOPWORDS Set 추가, searchTerms의 필터 체인에 stopword 제외 단계 추가"
          ],
          "verificationPlan": [
      ...
      "renderedMarkdown": "────────────────────────────────────────\nImplementation Brief\n────────────────────────────────────────\nTask: TASK-20260818-recall-memory-searchterms에-영어-불용어-필터-추가-adieum-a\nrecall/memory searchTerms에 영어 불용어 필터 추가 (adieum-api 벤치마크에서 발견된 FTS5 노이즈 버그 수정)\n\nA. Explicit decisions\n[EXPLICIT] DEC-0080. searchTerms에 영어 불용어 필터를 추가한다\nConfidence: 1.00\nSummary: 3글자 이상이면 무조건 검색어로 취급하던 필터에, and/the/for/with 같은 흔한 영어 함수어 목록(ENGLISH_STOPWORDS)을 추가로 제외한다. 이 단어들은 FTS5 OR 매칭에서 거의 모든 영어 문서와 매칭돼 무관한 결과를 대거 끌어들인다.\nRationale:\n  - sduck-recall-bench로 adieum-api(외부 실제 프로젝트, 영어 위주 결정 텍스트)를 평가하다가 재현함\n  - 쿼리 'Preserve depth and complexity denial-of-service protections'에서 'and'가 검색어에 포함돼 완전히 무관한 결정 20개가 상위권을 차지하는 것을 직접 확인함\nApplies to:\n  - src/core/v2/search.ts\nAvoids:\n  - 시맨틱/임베딩 검색 도입\n  - 한국어 형태소 분석기 도입\n\nB. Inferred decisions\n  - none\n\nC. Carried decisions\n  - none\n\nD. Conflicts\n  - none\n\nE. Open decisions\n  - none\n\nProblem:\n  recall/memory searchTerms에 영어 불용어 필터 추가 (adieum-api 벤치마크에서 발견된 FTS5 노이즈 버그 수정)\nImplementation plan:\n  - search.ts: ENGLISH_STOPWORDS Set 추가, searchTerms의 필터 체인에 stopword 제외 단계 추가\nVerification plan:\n  - npm run build && npm test && npm run lint\n  - 동일 쿼리로 sduck recall 재실행해 'and' 매칭 노이즈가 사라졌는지 확인\n  - sduck-recall-bench를 adieum-api에 재실행해 정량적 변화 확인\nScope expected:\n  - src/core/v2/search.ts\nScope avoided:\n  - 패러프레이즈로 인한 어휘 불일치 문제 자체는 이번 스코프 밖 (키워드 검색의 근본적 한계, 임베딩 검색이 필요한 더 큰 결정)\nOpen questions: 0\nEvidence:\n  - [DISCOVERY] sduck-recall-bench --verbose against adieum-api (0.7): DEC-0116 -> DEC-0024 쿼리 재현: 'and' 포함 시 top20 decisions가 전부 로그인/정산 등 무관한 내용으로 채워짐을 확인\n────────────────────────────────────────",
      "gitBaseline": {
        ...
        "dirtyFileHashes": {
          ...
          ".omc/state/hud-stdin-cache.json": "dccd974415655563247e72076a2fbaa5f8c6c4f526b4e29abeb56bbe432d49c8",
      ...
      "createdAt": "2026-08-18T02:43:52.679Z"
    }
  ],
  "evaluations": [
    {
      ...
      "checks": [
        ...
        {
          "name": "trace_note",
          "outcome": "IMPL-0033 empty due to same confirm-timing gap; will be corrected in a follow-up retrospective task"
        }
      ],
      "createdAt": "2026-08-18T02:44:26.683Z"
    }
  ],
  "events": [
    {
    ...
    },
    {
      ...
      "createdAt": "2026-08-18T02:42:03.376Z"
    },
    {
      "id": "EVT-0467",
      "taskId": "TASK-20260818-recall-memory-searchterms에-영어-불용어-필터-추가-adieum-a",
      ...
      "payload": {
        "reason": "adieum-api 벤치마크에서 발견: searchTerms가 3글자 이상 영어 단어를 걸러내지 않아 'and' 같은 흔한 접속사가 FTS5 OR 매칭에 포함되어 무관한 결과를 대거 끌어들임. 표준 영어 불용어 목록 추가로 수정",
        "carried": []
      },
      "createdAt": "2026-08-18T02:43:34.344Z"
    },
    {
      "id": "EVT-0468",
      "taskId": "TASK-20260818-recall-memory-searchterms에-영어-불용어-필터-추가-adieum-a",
      ...
      "createdAt": "2026-08-18T02:43:52.377Z"
    },
    {
      "id": "EVT-0469",
      "taskId": "TASK-20260818-recall-memory-searchterms에-영어-불용어-필터-추가-adieum-a",
    ...
    },
    {
      ...
      "createdAt": "2026-08-18T02:44:05.488Z"
    },
    {
      "id": "EVT-0472",
      "taskId": "TASK-20260818-recall-memory-searchterms에-영어-불용어-필터-추가-adieum-a",
      ...
      "payload": {
        "evaluationId": "EVAL-0016",
        "traceId": "IMPL-0033"
      },
      "createdAt": "2026-08-18T02:44:26.684Z"
    },
    {
      "id": "EVT-0473",
      "taskId": "TASK-20260818-recall-memory-searchterms에-영어-불용어-필터-추가-adieum-a",
      "type": "TASK_CLOSED",
      "payload": {},
      "createdAt": "2026-08-18T02:44:26.864Z"
    }
  ]
}
```
