...
이번 작업의 목표는 `sduck-assets/eval/task.yml`을 도입하고,
...
- [x] AC1: `sduck-assets/eval/task.yml`이 추가된다
...
- 새 asset 경로: `sduck-assets/eval/task.yml`
...
| 레이어                       | 파일 / 모듈                        | 변경 내용 요약                |
| ---------------------------- | ---------------------------------- | ----------------------------- |
| Assets                       | `sduck-assets/eval/task.yml`       | task 평가 기준 추가           |
| Docs                         | `AGENT.md`                         | task 평가 기준 사용 규칙 반영 |
| Docs                         | `CLAUDE.md`                        | task 평가 기준 사용 규칙 반영 |
| Assets                       | `sduck-assets/agent-rules/core.md` | task eval 경로 반영           |
...
- `sduck-assets/eval/spec.yml`
- `sduck-assets/eval/plan.yml`
- `AGENT.md`
- `CLAUDE.md`
